package faith.bibleqa.repository;

import faith.bibleqa.QahubApp;
import faith.bibleqa.config.Constants;
import faith.bibleqa.config.audit.AuditEventConverter;
import faith.bibleqa.domain.PersistentAuditEvent;
...
import static faith.bibleqa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
